...
public class ReservationCours extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idParam != null && !idParam.isEmpty()) {
            ...
            reservation = new Reservation(id, 1, Integer.parseInt(coursId), Date.valueOf(dateReservation), heureReservation);
        } else {
            reservation = new Reservation(1, Integer.parseInt(coursId), Date.valueOf(dateReservation), heureReservation);
        }
        ...
        try {
            ...
            Logger.getLogger(ReservationCours.class.getName()).log(Level.SEVERE, "Erreur lors de l'enregistrement de la réservation", ex);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (idDel != null && !idDel.isEmpty()) {
            try {
                ...
                response.sendRedirect(request.getContextPath() + "/reservationUser");
                return;
            } catch (NumberFormatException | SQLException ex) {
                Logger.getLogger(ReservationCours.class.getName()).log(Level.SEVERE, "Erreur lors de la suppression de la réservation", ex);
        ...
        if (idEdt != null && !idEdt.isEmpty()) {
            try {
                ...
                Logger.getLogger(ReservationCours.class.getName()).log(Level.SEVERE, "Erreur lors de la récupération de la réservation", ex);
        ...
        try {
            ...
            Logger.getLogger(ReservationCours.class.getName()).log(Level.SEVERE, "Erreur lors de la récupération de la liste des réservations", ex);
            throw new ServletException("Erreur lors de la récupération de la liste des réservations", ex);
        }

        RequestDispatcher dispatcher = request.getRequestDispatcher("jsp/client/reservationUser.jsp");
        dispatcher.forward(request, response);
    }
}
